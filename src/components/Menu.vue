<template>
    <div class="menu">
        <div class="container">
            <div class="links">
                <h2 class="title link home">Home</h2>
                <h2 class="title link">Products</h2>
                <h2 class="title link">About us</h2>
                <div class="social-links">
                    <div class="insta social-link">
            ...
            <div class="imgDiv">
                <img class="img" src="/assets/img/kamer-menu.jpg" alt="">
            </div>
        </div>
    </div>
</template>
